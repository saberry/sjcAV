...
Min = 5
```{r}
testFunc(salesOnly, 5, "Neighborhood") %>% 
  knitr::kable(., caption = "Neighborhood Results")
```

Min = 3
```{r}
testFunc(salesOnly, 3, "Neighborhood") %>% 
  knitr::kable(., caption = "Neighborhood Results")
```
...
Min = 5
```{r}
testFunc(salesOnly, 5, "school_district") %>% 
  knitr::kable(., caption = "School District Results")
```

Min = 3
```{r}
testFunc(salesOnly, 3, "school_district") %>% 
  knitr::kable(., caption = "School District Results")
```
...
Min = 5
```{r}
testFunc(salesOnly, 5, "tax_district") %>% 
...
Min = 5
```{r}
testFunc(salesOnly, 5, "Township") %>% 
  knitr::kable(., caption = "Township Results")
```

Min = 3
```{r}
testFunc(salesOnly, 3, "Township") %>% 
  knitr::kable(., caption = "Township Results")
```
...
Min = 5
```{r}
testFunc(salesOnly, 5, "tract") %>% 
  knitr::kable(., caption = "Tract Results")
```

Min = 3
```{r}
testFunc(salesOnly, 3, "tract") %>% 
  knitr::kable(., caption = "Tract Results")
```
...
```{r}
testFunc(salesOnly, 5, "school_district", "township") %>% 
...
```{r}
testFunc(salesOnly, 5, "township", "tax_district") %>% 
...
```{r}
testFunc(salesOnly, 5, "tax_district", "tract") %>% 
