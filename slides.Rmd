...
## Two-phase neighborhood evaluation
...
```{r}
testFunc(salesOnly, Flat2017, 5, "neighborhood") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 3, "neighborhood") %>% 
  knitr::kable(., caption = "Neighborhood Results")
```
...
```{r}
testFunc(salesOnly, Flat2017, 5, "school_district") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 3, "school_district") %>% 
  knitr::kable(., caption = "School District Results")
```
...
```{r}
testFunc(salesOnly, Flat2017, 5, "tax_district") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 3, "tax_district") %>% 
  knitr::kable(., caption = "Tax District Results")
```
...
```{r}
testFunc(salesOnly, Flat2017, 5, "township") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 3, "township") %>% 
  knitr::kable(., caption = "Township Results")
```
...
```{r}
testFunc(salesOnly, Flat2017, 5, "tract") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 3, "tract") %>% 
  knitr::kable(., caption = "Tract Results")
```
...
```{r}
testFunc(salesOnly, Flat2017, 5, "school_district", "township") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 5, "township", "tax_district") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 5, "tax_district", "tract") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 5, "schoolDistrictClusterNumber") %>% 
...
```{r}
testFunc(salesOnly, Flat2017, 5, "tractClusterNumber") %>% 
...
```{r}
testFunc(salesOnly2016, Flat2016, 5, "township") %>% 
  knitr::kable(., caption = "Township Results")
```

```{r}
testFunc(salesOnly2016, Flat2016, 5, "neighborhood") %>% 
  knitr::kable(., caption = "Neighborhood Results")
```

```{r}
testFunc(salesOnly2016, Flat2016, 5, "tractClusterNumber") %>% 
  knitr::kable(., caption = "Tract Results")
```
...
```{r}
testFunc(salesOnly2015, Flat2015, 5, "township") %>% 
  knitr::kable(., caption = "Township Results")
```

```{r}
testFunc(salesOnly2015, Flat2015, 5, "neighborhood") %>% 
  knitr::kable(., caption = "Neighborhood Results")
```

```{r}
testFunc(salesOnly2015, Flat2015, 5, "tractClusterNumber") %>% 
  knitr::kable(., caption = "Tract Results")
```
...
```{r}
testFunc(salesOnly2014, Flat2014, 5, "township") %>% 
  knitr::kable(., caption = "Township Results")
```

```{r}
testFunc(salesOnly2014, Flat2014, 5, "neighborhood") %>% 
  knitr::kable(., caption = "Neighborhood Results")
```

```{r}
testFunc(salesOnly2014, Flat2014, 5, "tractClusterNumber") %>% 
  knitr::kable(., caption = "Tract Results")
```
...
```{r}
testFunc(salesOnly2013, Flat2013, 5, "township") %>% 
  knitr::kable(., caption = "Township Results")
```

```{r}
testFunc(salesOnly2013, Flat2013, 5, "neighborhood") %>% 
  knitr::kable(., caption = "Neighborhood Results")
```

```{r}
testFunc(salesOnly2013, Flat2013, 5, "tractClusterNumber") %>% 
  knitr::kable(., caption = "Tract Results")
```
